...
export default function InvoiceAdd({updateInvoices,  index}) {
    ...
    useEffect(() => {
        if(action === "edit")
            setInvoice(JSON.parse(localStorage.getItem("invoices"))[parseInt(params)] )       
    }, [action])
                                                                ...
                                                                {invoice.items.map((item, i)=>{
                                                                    return (
                                                                        <tr>
                                                                            ...
                                                                            <td className="description"><input value = {item.description} name = "description" onChange = {(e)=>updateItem(e, i)} type="text" className="form-control form-control-sm" placeholder="Item Description" /> <textarea name = "details" value = {item.details} className="form-control" placeholder="Additional Details" defaultValue={""} /></td>
                                                                            <td className="rate">
                                                        ...
                                                        <div className="col-md-12 align-self-center">
                                                            <div className="form-group row invoice-note">
                                                                ...
                                                                <div className="col-sm-12">
                                                                    <textarea value = {invoice.notes} name = "notes" onChange = {handleChange} className="form-control" id="invoice-detail-notes" placeholder="Notes - For example, &quot;Thank you for doing business with us&quot;" style={{ height: 88 }} defaultValue={""} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="form-group mb-0">
                                                    ...
                                                    <div className="dropdown selectable-dropdown invoice-select">
                                                        ...
                                                        <div className="dropdown-menu" aria-labelledby="currencyDropdown">
                                                            <a onClick = {changeCurrency} className="dropdown-item" data-img-value="assets/img/flag-us.svg" data-value="USD - US Dollar" href="javascript:void(0);"><img src="assets/img/flag-us.svg" className="flag-width" alt="flag" /> USD - US Dollar</a>
                                                            <a onClick = {changeCurrency} className="dropdown-item" data-img-value="assets/img/flag-gbp.svg" data-value="GBP - British Pound" href="javascript:void(0);"><img src="assets/img/flag-gbp.svg" className="flag-width" alt="flag" /> GBP - British Pound</a>
                                                            <a onClick = {changeCurrency} className="dropdown-item" data-img-value="assets/img/flag-idr.svg" data-value="IDR - Indonesian Rupiah" href="javascript:void(0);"><img src="assets/img/flag-idr.svg" className="flag-width" alt="flag" /> IDR - Indonesian Rupiah</a>
                                                            <a onClick = {changeCurrency} className="dropdown-item" data-img-value="assets/img/flag-inr.svg" data-value="INR - Indian Rupee" href="javascript:void(0);"><img src="assets/img/flag-inr.svg" className="flag-width" alt="flag" /> INR - Indian Rupee</a>
                                                            <a onClick = {changeCurrency} className="dropdown-item" data-img-value="assets/img/flag-brl.svg" data-value="BRL - Brazilian Real" href="javascript:void(0);"><img src="assets/img/flag-brl.svg" className="flag-width" alt="flag" /> BRL - Brazilian Real</a>
                                                            <a onClick = {changeCurrency} className="dropdown-item" data-img-value="assets/img/flag-de.svg" data-value="EUR - Germany (Euro)" href="javascript:void(0);"><img src="assets/img/flag-de.svg" className="flag-width" alt="flag" /> EUR - Germany (Euro)</a>
                                                            <a onClick = {changeCurrency} className="dropdown-item" data-img-value="assets/img/flag-try.svg" data-value="TRY - Turkish Lira" href="javascript:void(0);"><img src="assets/img/flag-try.svg" className="flag-width" alt="flag" /> TRY - Turkish Lira</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="invoice-action-tax">
                                                ...
                                                <div className="invoice-action-tax-fields">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-6">
                                                            <div className="" style={{ display: tax_type === "None"?"none":"block" }}>
                                        ...
                                        <div className="invoice-actions-btn">
                                            <div className="invoice-action-btn">
                                                <div className="row">
                                                    ...
                                                    <div className="col-xl-12 col-md-4">
                                                        <button onClick = {saveInvoice} className="btn btn-success btn-download">Save</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
